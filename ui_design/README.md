...
| `instrument.html` | **A — TALLY.01** | Dark retro-industrial *precision instrument* |
| `editorial.html` | **B — COUNT** | Light Swiss-brutalist *editorial* sheet |
...
- **Hero:** a giant high-contrast **Fraunces** numeral that *ink-stamps* in on change with a red registration ghost.
...
Every prototype implements the complete spec, so you can *feel* the interactions, not just see them:
